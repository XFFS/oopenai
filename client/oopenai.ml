let __NOTE__ = "Generated by oooapi at 2024-1-21T0:30:38Z"
...
module Data = struct
  ...
  module ChatCompletionRequestMessageContentPartImage = struct
    type image_url =
      { image_url_url : [ `File of string | `String of string ]
            [@ocaml.doc
  ...
  module CreateFileRequest = struct
    type t =
      { file : [ `File of string | `String of string ]
  ...
  module CreateImageEditRequest = struct
    type t =
      { image : [ `File of string | `String of string ]
            [@ocaml.doc
      ...
      ; prompt : string
            ...
            [@key "prompt"]
            [@required]
      ; mask : [ `File of string | `String of string ] option
            [@ocaml.doc
